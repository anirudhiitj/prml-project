#!/bin/bash
# Script to RESUME V3 Improved Tuning from Epoch 70
...
echo "Resuming distributed tuning on GPU 6 from Epoch 70 for V3 Improved Model..."
...
torchrun \
    ...
    --bn_chan 128 \
    --hid_chan 512 \
    --resume_from "checkpoints/v3_improved/checkpoint_epoch_70.pt"
