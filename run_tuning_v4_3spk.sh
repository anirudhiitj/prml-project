#!/bin/bash
# Script to launch V4 3-Speaker Tuning (Baseline Architecture with Hyper-scaled Training Params)
...
echo "Starting distributed tuning on GPU 7 for V4 3-Speaker Model..."
